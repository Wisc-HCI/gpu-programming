...
Blockly.Blocks[transitionLEDType] = {
  init: function () {
    ...
    this.appendDummyInput("FIELD_TEXT_IGNORE").appendField("Transition LED");
    this.appendValueInput("COLOR1").setCheck("Colour").appendField("Color 1");
    this.appendValueInput("COLOR2").setCheck("Colour").appendField("Color 2");
    ...
    this.setNextStatement(true, null);
    this.setTooltip(
      "Transition LED between two colors with the specified transition type and time."
    );
...
Blockly.Blocks[displayImageType] = {
  init: function () {
    ...
    this.setNextStatement(true, null);
    this.setTooltip(
      "Displays an image on Misty's screen, Alpha specifies transparency (0 is completely transparent, 1 is completely opaque) ***WARNING: MUST connect with ListFilesAvailable to select the image file to display***"
    );
  },
};
...
Blockly.Blocks[moveArmType] = {
  init: function () {
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new MathNumSlider(45, -29, 90, 1, "Up", "Down"),
        "FIELD_MoveArm_Position"
      )
      .appendField("at a speed of (0 to 100)")
      .appendField(
        new MathNumSlider(50, 0, 100, 1, "Slow", "Fast"),
        "FIELD_MoveArm_Velocity"
      );
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip(
      "Moves one of Misty's arms to a specified position (expects a value from 0-10, 5 points the arm straight forward) at a specified speed (between 0 and 100)"
    );
  },
};
...
Blockly.Blocks[moveArm2Type] = {
  init: function () {
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new MathNumSlider(45, -29, 90, 1, "Up", "Down"),
        "FIELD_MoveArm2_Position"
      )
      .appendField("at a speed of (0 to 100)")
      .appendField(
        new MathNumSlider(50, 0, 100, 1, "Slow", "Fast"),
        "FIELD_MoveArm2_Velocity"
      );
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip(
      "Moves both of Misty's arms to a specified position (expects a value from 0-10, 5 points the arm straight forward) at a specified speed (between 0 and 100)"
    );
  },
};
...
Blockly.Blocks[basicSliderType] = {
  init: function () {
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new MathNumSlider(0, 0, 100, 1, "Min", "Max"),
        "FIELD_slider_value"
      );
    this.setInputsInline(false);
...
Blockly.Blocks[speedSliderType] = {
  init: function () {
    this.setColour(blockColors["math_category"]["colour"]);
    this.appendDummyInput().appendField(
      new MathNumSlider(1, 1, 100, 1, "Slow", "Fast"),
      "FIELD_slider_value"
    );
    this.setInputsInline(false);
    this.setPreviousStatement(false, null);
...
Blockly.Blocks[timeSliderType] = {
  init: function () {
    this.setColour(blockColors["math_category"]["colour"]);
    this.appendDummyInput().appendField(
      new MathNumSlider(1, 1, 60, 1, "Short", "Long"),
      "FIELD_slider_value"
    );
    this.setInputsInline(false);
    this.setPreviousStatement(false, null);
...
Blockly.Blocks[headPitchSliderType] = {
  init: function () {
    this.setColour(blockColors["math_category"]["colour"]);
    this.appendDummyInput().appendField(
      new MathNumSlider(0, -40, 25, 1, "Up", "Down"),
      "FIELD_slider_value"
    );
    this.setInputsInline(false);
    this.setPreviousStatement(false, null);
...
Blockly.Blocks[headRollSliderType] = {
  init: function () {
    this.setColour(blockColors["math_category"]["colour"]);
    this.appendDummyInput().appendField(
      new MathNumSlider(0, -40, 40, 1, "Right", "Left"),
      "FIELD_slider_value"
    );
    this.setInputsInline(false);
    this.setPreviousStatement(false, null);
...
Blockly.Blocks[headYawSliderType] = {
  init: function () {
    this.setColour(blockColors["math_category"]["colour"]);
    this.appendDummyInput().appendField(
      new MathNumSlider(0, -81, 81, 1, "Right", "Left"),
      "FIELD_slider_value"
    );
    this.setInputsInline(false);
    this.setOutput(true, null);
...
Blockly.Blocks[moveArms2Type] = {
  init: function () {
    ...
    this.setColour(blockColors["movement_category"]["colour"]);
    this.appendValueInput("FIELD_MoveArm_LeftPosition")
      .setCheck("Number")
      .appendField("Left Arm Position");
    var shadowBlockConnectionLPosition = this.getInput(
      "FIELD_MoveArm_LeftPosition"
    ).connection;
    shadowBlockConnectionLPosition.connect(lPosBlock);
    this.appendValueInput("FIELD_MoveArm_LeftVelocity")
      .setCheck("Number")
      .appendField("Left Arm Speed");
    var shadowBlockConnectionLVelocity = this.getInput(
      "FIELD_MoveArm_LeftVelocity"
    ).connection;
    shadowBlockConnectionLVelocity.connect(lVelBlock);
    this.appendValueInput("FIELD_MoveArm_RightPosition")
      .setCheck("Number")
      .appendField("Right Arm Position");
    var shadowBlockConnectionRPosition = this.getInput(
      "FIELD_MoveArm_RightPosition"
    ).connection;
    shadowBlockConnectionRPosition.connect(rPosBlock);
    this.appendValueInput("FIELD_MoveArm_RightVelocity")
      .setCheck("Number")
      .appendField("Right Arm Speed");
    var shadowBlockConnectionLVelocity = this.getInput(
      "FIELD_MoveArm_RightVelocity"
    ).connection;
    ...
    this.setNextStatement(true, null);
    this.setTooltip(
      "Moves both of Misty's arms to a specified position (expects a value from 0-10, 5 points the arm straight forward) at a specified speed"
    );
  },
};
...
Blockly.Blocks[MoveArm3Type] = {
  init: function () {
    ...
    this.setColour(blockColors["movement_category"]["colour"]);
    this.appendValueInput("FIELD_MoveArm_Position")
      .setCheck("Number")
      .appendField("Left Arm Position");
    var shadowBlockConnectionLPosition = this.getInput(
      "FIELD_MoveArm_Position"
    ...
    shadowBlockConnectionLPosition.connect(lPosBlock);
    this.appendValueInput("FIELD_MoveArm_Velocity")
      .setCheck("Number")
      .appendField("Left Arm Speed");
    var shadowBlockConnectionLVelocity = this.getInput(
      "FIELD_MoveArm_Velocity"
  ...
  init: function () {
    ...
    this.appendDummyInput()
      ...
      .appendField(
        ...
        "FIELD_DriveTime_Direction"
      )
      .appendField("at a speed of (0 to 100)")
      .appendField(
        new Blockly.FieldNumber(25, 0, 100, 1),
        "FIELD_DriveTime_Velocity"
      )
      .appendField("for a duration of")
      .appendField(
        new Blockly.FieldNumber(1, 0, 60, 1),
        "FIELD_DriveTime_TimeMs"
      )
      .appendField("secs");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip(
      "Drives Misty straight in a specified direction at a specified speed for a specified amount of time (1000ms = 1 second)"
    );
  },
};
...
Blockly.Blocks[MoveHead3Type] = {
  init: function () {
    ...
    this.appendDummyInput("FIELD_TEXT_IGNORE").appendField("Move head");
    this.appendValueInput("FIELD_MoveHead_Pitch")
      .setCheck("Number")
      .appendField("Look Up/Down:");
    var shadowBlockConnectionPitch = this.getInput(
      "FIELD_MoveHead_Pitch"
    ).connection;
    shadowBlockConnectionPitch.connect(pitchBlock);

    this.appendValueInput("FIELD_MoveHead_Roll")
      .setCheck("Number")
      .appendField("Tilt Left/Right:");
    var shadowBlockConnectionRoll = this.getInput(
      "FIELD_MoveHead_Roll"
    ).connection;
    shadowBlockConnectionRoll.connect(rollBlock);

    this.appendValueInput("FIELD_MoveHead_Yaw")
      .setCheck("Number")
      .appendField("Look Right/Left:");
    var shadowBlockConnectionYaw =
      this.getInput("FIELD_MoveHead_Yaw").connection;
    shadowBlockConnectionYaw.connect(yawBlock);

    this.appendValueInput("FIELD_MoveHead_Time")
      .setCheck("Number")
      .appendField("Time (seconds):");
    var shadowBlockConnectionTime = this.getInput(
      "FIELD_MoveHead_Time"
    ).connection;
    ...
    this.setNextStatement(true, null);
    this.setTooltip(
      "Moves Misty's head a specified amount of degrees with roll, pitch, and/or yaw"
    );
  },
};
...
Blockly.Blocks[DriveTime2Type] = {
  init: function () {
    ...
    this.setColour(blockColors["movement_category"]["colour"]);
    this.appendValueInput("FIELD_DriveTime_Velocity")
      .setCheck("Number")
      .appendField("Move at a speed of (-100 to 100)");
    var shadowBlockConnectionVelocity = this.getInput(
      "FIELD_DriveTime_Velocity"
    ).connection;
    ...
    this.setNextStatement(true, null);
    this.setTooltip(
      "Drives Misty forward (positive speed) or backward (negative speed) with possible turning using angular velocity (0 for straight) for the specified duration (1000 ms = 1 second)"
    );
  },
};
...
Blockly.Blocks[TurnType] = {
  init: function () {
    ...
    this.setNextStatement(true, null);
    this.setTooltip(
      "Turns Misty in the specified direction (1000ms = 1 second and 4500ms is approximately 90 degrees)"
    );
  },
};
...
Blockly.Blocks[Turn2Type] = {
  init: function () {
    ...
    this.appendValueInput("FIELD_Turn_Duration")
      .setCheck("Number")
      .appendField("for");
    var shadowBlockConnectionTime = this.getInput(
      "FIELD_Turn_Duration"
...
Blockly.Blocks[TurnOnFlashlightType] = {
  init: function () {
    this.setColour(blockColors["light_category"]["colour"]);
    this.appendDummyInput().appendField("Turn on flashlight ");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks[TurnOffFlashlightType] = {
  init: function () {
    this.setColour(blockColors["light_category"]["colour"]);
    this.appendDummyInput().appendField("Turn off flashlight ");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks[WaitForSecondsType] = {
  init: function () {
    ...
    this.setColour(blockColors["movement_category"]["colour"]);
    this.setTooltip(
      "Delay the execution of the next block by some number of seconds"
    );
...
Blockly.Blocks[SetVolumeType] = {
  init: function () {
    ...
    this.appendValueInput("FIELD_Volume")
      .setCheck("Number")
      .appendField("Set volume to (0-100): ");
    var shadowBlockConnectionAudioLevel =
      this.getInput("FIELD_Volume").connection;
...
Blockly.Blocks[ClearText] = {
  init: function () {
    this.setColour(blockColors["face_category"]["colour"]);
    this.appendDummyInput().appendField("Clear Text");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("");
  },
...
Blockly.Blocks[FrontLeftBumperPress] = {
  init: function () {
    this.setStyle("hat_blocks");
    this.setColour(blockColors["trigger_category"]["colour"]);
    this.appendDummyInput().appendField("Front Left Bumper Pressed");
    this.setNextStatement(true, null);
    this.setTooltip("");
  },
};
...
Blockly.Blocks[FrontRightBumperPress] = {
  init: function () {
    this.setStyle("hat_blocks");
    this.setColour(blockColors["trigger_category"]["colour"]);
    this.appendDummyInput().appendField("Front Right Bumper Pressed");
    this.setNextStatement(true, null);
    this.setTooltip("");
  },
};
...
Blockly.Blocks[RearLeftBumperPress] = {
  init: function () {
    this.setStyle("hat_blocks");
    this.setColour(blockColors["trigger_category"]["colour"]);
    this.appendDummyInput().appendField("Rear Left Bumper Pressed");
    this.setNextStatement(true, null);
    this.setTooltip("");
  },
};
...
Blockly.Blocks[RearRightBumperPress] = {
  init: function () {
    this.setStyle("hat_blocks");
    this.setColour(blockColors["trigger_category"]["colour"]);
    this.appendDummyInput().appendField("Right Rear Bumper Pressed");
    this.setNextStatement(true, null);
    this.setTooltip("");
  },
};
...
Blockly.Blocks[eyes_acceptance] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: acceptance");
...
Blockly.Blocks[eyes_admiration] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: admiration");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_amazement] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: amazement");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_anger] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: anger");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_annoyed] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: annoyed");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_anticipation] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: anticipation");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_apprehension] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: apprehension");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_boredom] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: boredom");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_default] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: default");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_disgust] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: disgust");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_distraction] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: distraction");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_ecstasy_frame_1] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: ecstasy 1");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_ecstasy_frame_2] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: ecstasy 2");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_fear] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: fear");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_grief] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: grief");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_interest] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: interest");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_joy] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: joy");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_loathing] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: loathing");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_pensiveness] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: pensiveness");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_rage] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: rage eyes");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_sad] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: sad");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_serenity] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: serenity");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_surprise] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: surprise");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_terror] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: terror");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_trust] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: trust");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[eyes_vigilance] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: vigilance");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_Sleeping] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: sleeping");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_SleepingZZZ] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: sleeping ZZZ");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_Contempt] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: contempt");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_ContentLeft] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: content (left)");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_ContentRight] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: content (right)");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_Disoriented] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: disoriented");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_EcstacyHilarious] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: ecstacy hilarious");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_EcstacyStarryEyed] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: ecstacy starry eyed");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_JoyGoofy] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: joy goofy");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_JoyGoofy2] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: joy goofy 2");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_JoyGoofy3] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: joy goofy 3");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_Love] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: love");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_Rage] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: rage");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_Rage2] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: rage 2");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_Rage3] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: rage 3");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_Rage4] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: rage 4");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[e_RemorseShame] = {
  init: function () {
    this.appendDummyInput().appendField("Expression: remorse shame");
    this.setOutput(true, "Face");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks["animation_sleepy.bv"] = {
  init: function () {
    this.appendDummyInput().appendField("Animation: Sleeping");
...
Blockly.Blocks["animation_dancing.bv"] = {
  init: function () {
    this.appendDummyInput().appendField("Animation: Dancing");
    this.setOutput(true, "Animation");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks["animation_spooked.bv"] = {
  init: function () {
    this.appendDummyInput().appendField("Animation: Spooked");
    this.setOutput(true, "Animation");
    this.setColour(blockColors["face_category"]["colour"]);
...
Blockly.Blocks[s_Acceptance] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: acceptance");
...
Blockly.Blocks[s_Amazement] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: amazement");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Amazement2] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: amazement 2");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Anger] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: anger");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Anger2] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: anger 2");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Anger3] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: anger 3");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Anger4] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: anger 4");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Annoyance] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: annoyance");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Annoyance2] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: annoyance 2");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Annoyance3] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: annoyance 3");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Annoyance4] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: annoyance 4");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Awe] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: awe");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Awe2] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: awe 2");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Awe3] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: awe 3");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Boredom] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: boredom");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Disapproval] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: disapproval");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Disgust] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: disgust");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Disgust2] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: disgust 2");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Disgust3] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: disgust 3");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_DisorientedConfused] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: disoriented confused");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_DisorientedConfused2] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: disoriented confused 2");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_DisorientedConfused3] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: disoriented confused 3");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_DisorientedConfused4] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: disoriented confused 4");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_DisorientedConfused5] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: disoriented confused 5");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_DisorientedConfused6] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: disoriented confused 6");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Distraction] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: distraction");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Ecstacy] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: ecstacy");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Ecstacy2] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: ecstacy 2");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Fear] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: fear");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Grief] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: grief");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Grief2] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: grief 2");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Grief3] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: grief 3");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Grief4] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: grief 4");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Joy] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: joy");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Joy2] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: joy 2");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Joy3] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: joy 3");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Joy4] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: joy 4");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Loathing] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: loathing");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Love] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: love");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_PhraseByeBye] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: Bye Bye");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_PhraseEvilAhHa] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: Evil Ah Ha");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_PhraseHello] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: Hello");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_PhraseNoNoNo] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: No No No");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_PhraseOopsy] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: Oopsy");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_PhraseOwOwOw] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: Ow Ow Ow");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_PhraseOwwww] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: Owwww");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_PhraseUhOh] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: Uh Oh");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Rage] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: rage");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Sadness] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sadness");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Sadness2] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sadness 2");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Sadness3] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sadness 3");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Sadness4] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sadness 4");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Sadness5] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sadness 5");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Sadness6] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sadness 6");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Sadness7] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sadness 7");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Sleepy] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sleepy");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Sleepy2] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sleepy 2");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Sleepy3] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sleepy 3");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_Sleepy4] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sleepy 4");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_SleepySnore] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: sleepy snore");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
...
Blockly.Blocks[s_SystemCameraShutter] = {
  init: function () {
    this.appendDummyInput().appendField("Sound: system camera shutter");
    this.setOutput(true, "Audio");
    this.setColour(blockColors["audio_category"]["colour"]);
